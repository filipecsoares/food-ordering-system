package com.fcs.food.ordering.system.order.service.domain.mapper;

import com.fcs.food.ordering.system.domain.valueobject.CustomerId;
...
import com.fcs.food.ordering.system.domain.valueobject.RestaurantId;
...
public class OrderDataMapper {
    public Restaurant createOrderCommandToRestaurant(CreateOrderCommand createOrderCommand) {
        return Restaurant.builder()
                ...
                .products(createOrderCommand.getItems().stream().map(item -> new Product(new ProductId(item.getProductId())))
    ...
    private List<OrderItem> orderItemsToOrderItemsEntities(List<com.fcs.food.ordering.system.order.service.domain.dto.create.OrderItem> items) {
